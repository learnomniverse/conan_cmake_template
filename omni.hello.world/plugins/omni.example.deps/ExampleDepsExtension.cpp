...
#include <omni/example/deps/IExampleDepsInterface.h>
...
const struct carb::PluginImplDesc pluginImplDesc = { "omni.example.deps.plugin",
...
class ExampleDepsExtension : public IExampleDepsInterface,
...
protected:
    ...
    void onDefaultUsdStageChanged(long stageId) override
    {
        ...
        if (stageId)
        {
            ...
            m_usdNoticeListenerKey = PXR_NS::TfNotice::Register(PXR_NS::TfCreateWeakPtr(this), &ExampleDepsExtension::onObjectsChanged);
        }
    }
...
CARB_PLUGIN_IMPL(pluginImplDesc, omni::example::deps::ExampleDepsExtension)

void fillInterface(omni::example::deps::ExampleDepsExtension& iface)
{
}
